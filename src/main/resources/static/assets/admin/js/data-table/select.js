...
(function (h) {
    ...
    function N(a) {
        ...
        if (b._select.info &&
            ...
            var c = a.rows({selected: !0}).flatten().length, d = a.columns({selected: !0}).flatten().length,
                e = a.cells({selected: !0}).flatten().length, g = function (f, k, n) {
    ...
    m.select.init = function (a) {
        ...
        if (!b._select) {
            ...
            var e = b.oInit.select, g = m.defaults.select;
            e = e === l ? g : e;
            g = "row";
            var f = "api", k = !1, n = !0, q = !0, y = "td, th", M = "selected", B = !1;
            b._select = {};
            !0 === e ? (f = "os", B = !0) : "string" ===
    ...
    var v = m.Api.register, x = m.Api.registerPlural;
    v("select()", function () {
    ...
    x("columns().deselect()", "column().deselect()", function () {
        ...
        this.iterator("column", function (b, c) {
            ...
            var d = new m.Api(b), e = d.column(c);
    ...
    h.extend(m.ext.buttons, {
        selected: {
            ...
            className: "buttons-selected-single", init: function (a, b, c) {
                var d = this;
                c._eventNamespace = ".select" + H++;
                a.on(F(c), function () {
            ...
            text: A("selectAll", "Select all"), className: "buttons-select-all", action: function () {
